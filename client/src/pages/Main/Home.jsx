...
const Home = () => {
    ...
    <section className="relative">
        <h1 className="text-6xl">Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore perspiciatis incidunt corporis adipisci, sit quaerat eligendi accusantium eius ducimus eaque maxime a, voluptatem hic accusamus itaque nemo! Doloremque eum odit minima pariatur autem vel fugit, temporibus in, consequuntur aperiam perspiciatis sint dolorum ipsum aspernatur asperiores repudiandae atque? Veritatis ipsam id laboriosam molestiae, necessitatibus nostrum doloremque consectetur cumque pariatur sapiente? Hic atque debitis optio cum molestiae ipsa excepturi. Iusto, doloremque sunt voluptatibus voluptates minus debitis animi autem hic cum recusandae dolores? Corrupti atque cumque ut natus quos esse est quaerat? Ipsum perferendis nihil officiis accusantium porro animi et, incidunt saepe consequatur.</h1>
    <div className="absolute inset-0 m-auto max-w-xs h-[357px] blur-[118px] sm:max-w-md md:max-w-lg" style={{ background: "linear-gradient(106.89deg, rgba(192, 132, 252, 0.11) 15.73%, rgba(14, 165, 233, 0.41) 15.74%, rgba(232, 121, 249, 0.26) 56.49%, rgba(79, 70, 229, 0.4) 115.91%)" }}></div>
    </section>
       </section>
    );
